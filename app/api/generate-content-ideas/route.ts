...
export async function POST(req: NextRequest) {
  ...
  let body: { appName?: string; pitch?: string };
  ...
  const system =
    ...
    'From the app and its pitch, generate 8 distinct, scroll-stopping content ideas to promote it organically. ' +
  ...
  const userMsg = `App : ${appName || '(sans nom)'}\nPitch :\n${pitch}`;
