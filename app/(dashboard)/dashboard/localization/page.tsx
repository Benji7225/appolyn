  ...
  return (
    <div className="p-8 scrollbar-macos">
      <PageHeader
        ...
        actions={
          <Link href="/dashboard/metadata" className="inline-flex items-center gap-1.5 text-sm rounded-lg px-3 h-9 bg-foreground text-background font-medium hover:opacity-90 transition-opacity">
            ...
            <div className="bg-card border border-border/40 rounded-xl p-5">
              <div className="flex items-center justify-between mb-3">
                ...
                {missingList.length > 0 && (
                  <Link href="/dashboard/metadata" className="text-xs text-primary hover:underline whitespace-nowrap">Générer avec l&apos;IA →</Link>
                )}
              </div>
              {missingList.length === 0 ? (
