...
const COMMANDS: Cmd[] = [
  { label: 'Accueil', href: '/app', group: 'Général', icon: LayoutGrid, keywords: 'home dashboard accueil' },
  ...
  { label: 'Competitors', href: '/app/competitors', group: 'Général', icon: Swords, keywords: 'concurrents competitors analyse ia teardown strategie differenciation positionnement' },
